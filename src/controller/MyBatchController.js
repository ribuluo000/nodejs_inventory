    ...
    async get_list(req, res, next) {
        ...
        const callback_check_form_data = async (result_check_form_data) => {
            if (result_check_form_data.passed) {
                ...
                try {
                    const result_paginate = await MyModel.paginate({ object_id_product : product_id,object_id_created_by:user_id }, { sort:'-create_time',page : page_number, limit : page_size });
